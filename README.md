...
## Quick Start
To enable Ouro OS wiki maintenance in your project, copy the entire content of `ouro/AGENT.md` and append it to your project's `CLAUDE.md` or `GEMINI.md` file.
