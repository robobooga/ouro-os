...
Objective
Establish a compounding, product-agnostic "LLM Wiki" system inside the ouro/wiki/ directory, supported by an offline-first dashboard in the ouro-webui/ directory. This system will serve as the persistent knowledge base for the project, maintained by the LLM and curated by the developer.
...
the ouro/ and ouro-webui/ folders and reset the content while keeping the core schemas and scripts.
